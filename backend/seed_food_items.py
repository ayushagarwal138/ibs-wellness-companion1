...
async def seed_food_items():
    ...
    foods = [
        ...
        # Indian Curry Dishes
        {'id': '650e8400-e29b-41d4-a716-446655440065', 'name': 'Dal Tadka', 'category': 'Indian Curries', 'fodmap_level': 'high', 'calories_per_100g': 108, 'fiber_per_100g': 4.2, 'fat_per_100g': 3.5, 'protein_per_100g': 6.8, 'carbs_per_100g': 14.0, 'common_triggers': True},
        ...
        {'id': '650e8400-e29b-41d4-a716-446655440073', 'name': 'Sambar', 'category': 'Indian Curries', 'fodmap_level': 'high', 'calories_per_100g': 95, 'fiber_per_100g': 3.8, 'fat_per_100g': 2.5, 'protein_per_100g': 4.2, 'carbs_per_100g': 15.0, 'common_triggers': True},
        {'id': '650e8400-e29b-41d4-a716-446655440074', 'name': 'Kadhi', 'category': 'Indian Curries', 'fodmap_level': 'medium', 'calories_per_100g': 78, 'fiber_per_100g': 1.2, 'fat_per_100g': 4.5, 'protein_per_100g': 3.8, 'carbs_per_100g': 7.0, 'common_triggers': True},
        ...
        try:
            for food_data in foods:
                ...
                result = await db.execute(
                    text("SELECT id FROM food_items WHERE id = :id"),
                    {"id": food_data['id']}
                )
