...
class UserSyncEvent:
    ...
    def __init__(
        ...
        self.event_type = (
            event_type  # 'profile_update', 'ml_prediction', 'validation_error'
        )
        self.data = data
...
class UserSyncService:
        ...
        try:
            ...
            sync_result = {
                ...
                "user": user_response.model_dump(
                    mode="json"
                ),  # Use model_dump with json mode for proper serialization
                "changes": changes,
                "timestamp": datetime.utcnow().isoformat(),
    ...
    async def _generate_ml_predictions(
        ...
        try:
            ...
            recommendations = (
                await self.enhanced_service.generate_enhanced_recommendations(
    ...
    async def _broadcast_user_update(self, user_id: str, update_data: Dict[str, Any]):
        ...
        if user_id in self.active_connections:
            ...
            event = UserSyncEvent(
                user_id=user_id, event_type="profile_update", data=update_data
            )
