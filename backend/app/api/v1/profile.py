...
async def get_basic_info(
    ...
    if current_user.gender:
        ...
        gender_value = gender_mapping.get(current_user.gender.value if hasattr(current_user.gender, 'value') else str(current_user.gender))
...
async def update_basic_info(
    ...
    allowed_fields = {
        ...
        "emergency_contact_phone", "timezone", "height_cm", "weight_kg"
    }
...
async def get_medical_history(
    ...
    if current_user.ibs_type:
        ...
        ibs_type_value = ibs_mapping.get(current_user.ibs_type.value if hasattr(current_user.ibs_type, 'value') else str(current_user.ibs_type))
...
async def get_dietary_preferences(
    ...
    dietary_prefs = {}
    if current_user.privacy_settings and isinstance(current_user.privacy_settings, dict):
...
async def update_dietary_preferences(
    ...
    updated_user = await UserService.update_user_profile(db, current_user.id, {
...
async def get_lifestyle_factors(
    ...
    if current_user.notification_preferences and isinstance(current_user.notification_preferences, dict):
        lifestyle_factors = current_user.notification_preferences.get("lifestyle_factors", {})
...
async def get_goals_preferences(
    ...
    return {
        ...
        "preferredCommunicationStyle": goals_preferences.get("preferredCommunicationStyle", "encouraging"),
