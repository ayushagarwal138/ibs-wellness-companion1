#!/usr/bin/env python3
"""
Test authentication flow against staging backend.
"""
...
def test_auth_flow():
    ...
    print("🔐 Testing Authentication Flow (Staging)")
    print("=" * 50)
        ...
        if login_response.status_code == 200:
            ...
            try:
                ...
                if ml_response.status_code == 200:
                    ...
                    print(f"   Response: {ml_response.json()}")
                else:
            ...
            try:
                ...
                if rt_response.status_code == 200:
                    ...
                    print(f"   Response: {rt_response.json()}")
                else:
